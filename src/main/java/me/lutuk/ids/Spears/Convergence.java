...
public class Convergence {
    ...
    public static ItemStack Convergence(ItemStack mainHandItem,int i) throws IOException {
        ...
        String healthRegenPercent = getLore.get(i+2);
        ...
        String thunderDamage = getLore.get(i+3);
        ...
        String earthDamage = getLore.get(i+4);
        ...
        String airDefense = getLore.get(i+5);
        ...
        String sprintRegen = getLore.get(i+6);
        ...
        String thirdSpellPercent = getLore.get(i+7);
