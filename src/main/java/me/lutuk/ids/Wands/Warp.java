...
public class Warp {
    ...
    public static ItemStack Warp(ItemStack mainHandItem) throws IOException {
        ...
        String hprPercent= getLore.get(4);
        ...
        String manaRegen= getLore.get(5);
        ...
        String walkSpeed= getLore.get(8);
        ...
        String airDamage= getLore.get(10);
        ...
        String firstSpellRaw= getLore.get(11);
        ...
        String secondSpellRaw= getLore.get(12);
        ...
        int finalWeight1 = (int) Math.round(reflectionWeight1+explodingWeight1+walkSpeedWeight1+rawHprWeight1+airDamageWeight1+firstSpellRawWeight1+secondSpellRawWeight1);
        int finalWeight2 = (int) Math.round(reflectionWeight2+explodingWeight2+walkSpeedWeight2+rawHprWeight2+airDamageWeight2+firstSpellRawWeight2+secondSpellRawWeight2);
