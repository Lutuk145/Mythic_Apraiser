...
public class Quetzalcoatl {
    ...
    public static ItemStack Quetzalcoatl(ItemStack mainHandItem) throws IOException {
        ...
        String walkSpeed = getLore.get(3);
        ...
        String waterDamage = getLore.get(4);
        ...
        String jumpHeighy = getLore.get(7);
