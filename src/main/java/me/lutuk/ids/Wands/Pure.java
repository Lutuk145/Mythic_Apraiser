...
public class Pure {
    ...
    public static ItemStack Pure(ItemStack mainHandItem) throws IOException {
        ...
        String manaSteal= getLore.get(2);
        ...
        String meleeDamage= getLore.get(6);
