...
public class Grandmother {
    ...
    public static ItemStack Grandmother(ItemStack mainHandItem) throws IOException {
        ...
        String lootBonus= getLore.get(7);
        ...
        String spellPercent= getLore.get(10);
        ...
        String meleePercent= getLore.get(11);
