...
public class Olympic {
    ...
    public static ItemStack  Olympic(ItemStack mainHandItem) throws IOException {
        ...
        String airDamage= getLore.get(5);
        ...
        String airDefense= getLore.get(6);
        ...
        String firstSpellRaw= getLore.get(7);
        ...
        String secondSpellRaw= getLore.get(8);
        ...
        String jumpHeight= getLore.get(9);
