...
public class Fantasia {
    ...
    public static ItemStack Fantasia(ItemStack mainHandItem) throws IOException {
        ...
        String seconSpellPercent = getLore.get(8);
        ...
        String thirdSpellPercent = getLore.get(9);
        ...
        String fourthSpellPercent = getLore.get(10);
