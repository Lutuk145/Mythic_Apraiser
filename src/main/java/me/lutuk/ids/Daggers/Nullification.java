...
public class Nullification {
    ...
    public static ItemStack Nullification(ItemStack mainHandItem,int i) throws IOException {
        ...
        String thunderDefense= getLore.get(i+11);
        ...
        String earthDefense= getLore.get(i+12);
